LOCALES = {
    "ru": {
        ...
        "choose_role": "<tg-emoji emoji-id=\"5275979556308674886\">🤝</tg-emoji> <b>Выберите вашу роль в сделке:</b>",
        ...
        "history_cleared": "<tg-emoji emoji-id=\"5278578973595427038\">🗑</tg-emoji> <b>История сделок очищена.</b>",
        "menu_caption": """
<tg-emoji emoji-id="5276262671962892944">🏠</tg-emoji> <b>FunPay</b>

<tg-emoji emoji-id="5278753302023004775">🛡</tg-emoji> Безопасный гарант для сделок в Telegram.

<b>Что внутри:</b>

• Защита от мошенников
• Средства удерживаются до завершения сделки
• История всех сделок
• Поддержка 24/7
...
""",
        "deal_rules": """
<tg-emoji emoji-id="5278753302023004775">📄</tg-emoji> <b>Правила сделки</b>

1. Сделка считается завершенной, после подтверждения оплаты и передачи товара.
...
Нажимая «Принимаю», вы соглашаетесь с правилами сделки.
""",
        "agree": "Принимаю",
        "wait_5_seconds": "⏳ Подождите 5 секунд перед согласием.",
        "describe_item": "<tg-emoji emoji-id=\"5278305362703835500\">📝</tg-emoji> <b>Опишите предмет сделки</b>",
        "enter_amount": "<tg-emoji emoji-id=\"{emoji_id}\">💰</tg-emoji> <b>Введите сумму сделки в {currency}</b>\n\nТолько целое число.",
        "deal_created": "<tg-emoji emoji-id=\"5278411813468269386\">🔐</tg-emoji> <b>Создание сделки...</b>",
        "deal_info": """
<tg-emoji emoji-id="5278411813468269386">🔐</tg-emoji> <b>Сделка</b> <code>{code}</code>

<tg-emoji emoji-id="5278305362703835500">📝</tg-emoji> <b>Предмет сделки:</b> {item}
...
""",
        "cannot_join_own_deal": "<tg-emoji emoji-id=\"5278578973595427038\">❌</tg-emoji> <b>Вы не можете подключиться к своей сделке.</b>",
        "you_joined_buyer": "<tg-emoji emoji-id=\"5278411813468269386\">🔐</tg-emoji> <b>Вы подключились к сделке</b>",
        "seller_joined": "<tg-emoji emoji-id=\"5278411813468269386\">🔐</tg-emoji> <b>Продавец подключился к сделке</b>",
        "buyer_joined": "<tg-emoji emoji-id=\"5278411813468269386\">🔐</tg-emoji> <b>Покупатель подключился к сделке</b>",
        ...
        "deal_joined": """
<tg-emoji emoji-id="5278227821364275264">💼</tg-emoji> <b>Сделка</b> <code>{code}</code>
...
""",
        ...
        "deal_finished": """
<tg-emoji emoji-id="5278411813468269386">🔐</tg-emoji> <b>Сделка <code>{code}</code> завершена</b>
...
""",
        ...
        "withdraw_after_2_deals": "<tg-emoji emoji-id=\"5278578973595427038\">❌</tg-emoji> <b>Вывод средств доступен после 2 сделок.</b>\n\nСейчас у вас: {deals} сделок",
...
""",
        ...
        "no_deals": "<tg-emoji emoji-id=\"5278578973595427038\">❌</tg-emoji> <b>У вас нет сделок.</b>",
        "my_deals": """
<tg-emoji emoji-id="5278227821364275264">💼</tg-emoji> <b>Мои сделки</b>

<b>Общее количество сделок:</b> {total}
<b>Завершенные сделки:</b> {finished}

Ниже указаны только завершенные сделки.
""",
        "deal_info_caption": """
<tg-emoji emoji-id="5278753302023004775">📄</tg-emoji> <b>Сделка</b> <code>{code}</code>

<tg-emoji emoji-id="5275979556308674886">🤝</tg-emoji> <b>Ваша роль:</b> {role}
<b>Продавец:</b> {seller_name}
<b>Покупатель:</b> {buyer_name}

<b>Предмет сделки:</b> {item}
<b>Сумма:</b> {amount} {currency}

<tg-emoji emoji-id="5278411813468269386">🔐</tg-emoji> <b>Статус:</b> завершена
...
Верификация доступна пользователям с 20+ успешными сделками и оборотом от 250 USDT.
...
""",
        ...
        "deal_not_found": "<tg-emoji emoji-id=\"5278578973595427038\">❌</tg-emoji> Сделка не найдена.",
    ...
    "en": {
        ...
        "choose_role": "<tg-emoji emoji-id=\"5275979556308674886\">🤝</tg-emoji> <b>Choose your role in the deal:</b>",
        ...
        "history_cleared": "<tg-emoji emoji-id=\"5278578973595427038\">🗑</tg-emoji> <b>Deal history cleared.</b>",
        "menu_caption": """
<tg-emoji emoji-id="5276262671962892944">🏠</tg-emoji> <b>FunPay</b>

<tg-emoji emoji-id="5278753302023004775">🛡</tg-emoji> Safe escrow service for Telegram deals.
...
""",
        "deal_rules": """
<tg-emoji emoji-id="5278753302023004775">📄</tg-emoji> <b>Deal rules</b>

1. The deal is considered completed after payment confirmation and goods transfer.
...
7. The administration is not responsible for the failure of the buyer or seller to comply with the deal rules.

By clicking "I agree", you accept the deal rules.
""",
        "agree": "I agree",
        "wait_5_seconds": "⏳ Please wait 5 seconds before agreeing.",
        "describe_item": "<tg-emoji emoji-id=\"5278305362703835500\">📝</tg-emoji> <b>Describe the item of the deal</b>",
        "enter_amount": "<tg-emoji emoji-id=\"{emoji_id}\">💰</tg-emoji> <b>Enter the deal amount in {currency}</b>\n\nInteger only.",
        "deal_created": "<tg-emoji emoji-id=\"5278411813468269386\">🔐</tg-emoji> <b>Creating deal...</b>",
        "deal_info": """
<tg-emoji emoji-id="5278411813468269386">🔐</tg-emoji> <b>Deal</b> <code>{code}</code>
...
""",
        "cannot_join_own_deal": "<tg-emoji emoji-id=\"5278578973595427038\">❌</tg-emoji> <b>You cannot join your own deal.</b>",
        "you_joined_buyer": "<tg-emoji emoji-id=\"5278411813468269386\">🔐</tg-emoji> <b>You have joined the deal</b>",
        "seller_joined": "<tg-emoji emoji-id=\"5278411813468269386\">🔐</tg-emoji> <b>Seller has joined the deal</b>",
        "buyer_joined": "<tg-emoji emoji-id=\"5278411813468269386\">🔐</tg-emoji> <b>Buyer has joined the deal</b>",
        ...
        "deal_joined": """
<tg-emoji emoji-id="5278227821364275264">💼</tg-emoji> <b>Deal</b> <code>{code}</code>
...
""",
        ...
        "deal_finished": """
<tg-emoji emoji-id="5278411813468269386">🔐</tg-emoji> <b>Deal <code>{code}</code> completed</b>
...
""",
        ...
        "withdraw_after_2_deals": "<tg-emoji emoji-id=\"5278578973595427038\">❌</tg-emoji> <b>Withdrawal is available after 2 deals.</b>\n\nYou have {deals} deals now",
...
""",
        ...
        "no_deals": "<tg-emoji emoji-id=\"5278578973595427038\">❌</tg-emoji> <b>You have no deals.</b>",
        "my_deals": """
<tg-emoji emoji-id="5278227821364275264">💼</tg-emoji> <b>My deals</b>

<b>Total deals:</b> {total}
<b>Finished deals:</b> {finished}

Only finished deals are shown below.
""",
        "deal_info_caption": """
<tg-emoji emoji-id="5278753302023004775">📄</tg-emoji> <b>Deal</b> <code>{code}</code>
...
<tg-emoji emoji-id="5278411813468269386">🔐</tg-emoji> <b>Status:</b> finished
...
Verification is available for users with 20+ successful deals and turnover from 250 USDT.
...
""",
        ...
        "deal_not_found": "<tg-emoji emoji-id=\"5278578973595427038\">❌</tg-emoji> Deal not found.",
        "buy_usage": "Usage:\n/buy CODE",
    ...
    "cn": {
        ...
        "choose_role": "<tg-emoji emoji-id=\"5275979556308674886\">🤝</tg-emoji> <b>请选择您在交易中的角色：</b>",
        ...
        "history_cleared": "<tg-emoji emoji-id=\"5278578973595427038\">🗑</tg-emoji> <b>交易历史已清空。</b>",
        "menu_caption": """
<tg-emoji emoji-id="5276262671962892944">🏠</tg-emoji> <b>FunPay</b>

<tg-emoji emoji-id="5278753302023004775">🛡</tg-emoji> Telegram 安全担保交易
...
""",
        ...
        "describe_item": "<tg-emoji emoji-id=\"5278305362703835500\">📝</tg-emoji> <b>描述交易物品</b>",
        "enter_amount": "<tg-emoji emoji-id=\"{emoji_id}\">💰</tg-emoji> <b>输入 {currency} 交易金额</b>\n\n仅限整数。",
        "deal_created": "<tg-emoji emoji-id=\"5278411813468269386\">🔐</tg-emoji> <b>创建交易...</b>",
        "deal_info": """
<tg-emoji emoji-id="5278411813468269386">🔐</tg-emoji> <b>交易</b> <code>{code}</code>
...
""",
        "cannot_join_own_deal": "<tg-emoji emoji-id=\"5278578973595427038\">❌</tg-emoji> <b>您不能加入自己的交易。</b>",
        "you_joined_buyer": "<tg-emoji emoji-id=\"5278411813468269386\">🔐</tg-emoji> <b>您已加入交易</b>",
        "seller_joined": "<tg-emoji emoji-id=\"5278411813468269386\">🔐</tg-emoji> <b>卖家已加入交易</b>",
        "buyer_joined": "<tg-emoji emoji-id=\"5278411813468269386\">🔐</tg-emoji> <b>买家已加入交易</b>",
        ...
        "deal_joined": """
<tg-emoji emoji-id="5278227821364275264">💼</tg-emoji> <b>交易</b> <code>{code}</code>
...
""",
        ...
        "deal_finished": """
<tg-emoji emoji-id="5278411813468269386">🔐</tg-emoji> <b>交易 <code>{code}</code> 已完成</b>
...
""",
        ...
        "withdraw_after_2_deals": "<tg-emoji emoji-id=\"5278578973595427038\">❌</tg-emoji> <b>完成2笔交易后方可提现。</b>\n\n您现在有 {deals} 笔交易",
...
""",
        ...
        "no_deals": "<tg-emoji emoji-id=\"5278578973595427038\">❌</tg-emoji> <b>您没有交易。</b>",
        "my_deals": """
<tg-emoji emoji-id="5278227821364275264">💼</tg-emoji> <b>我的交易</b>
...
""",
        "deal_info_caption": """
<tg-emoji emoji-id="5278753302023004775">📄</tg-emoji> <b>交易</b> <code>{code}</code>
...
<tg-emoji emoji-id="5278411813468269386">🔐</tg-emoji> <b>状态：</b> 已完成
...
验证适用于拥有20+成功交易且营业额超过250 USDT的用户。
...
<b>3. 交易如何运作？</b>
<tg-emoji emoji-id="5206202791768393003">⚙️</tg-emoji> 所有交易自动进行：机器人持有商品和付款，双方确认后释放。
...
""",
        ...
        "deal_not_found": "<tg-emoji emoji-id=\"5278578973595427038\">❌</tg-emoji> 交易未找到。",
        "buy_usage": "用法：\n/buy 代码",
